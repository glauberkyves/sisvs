...
class InstituicaoController extends CrudController
{

    protected $service = 'datasus_sisvs_expoepi_administrativo.instituicao';
    protected $baseRoute = 'datasus_sisvs_expoepi_administrativo_instituicao';

		public function searchAction()
		{
				$request   = $this->getRequest();
				$data      = $this->getService()->listaInstituicoes($request);
    ...
    public function editAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            $this->entity->setNoInstituicao($this->entity->getNoInstituicao());
            $this->entity->setDsInstituicao($this->entity->getDsInstituicao());
