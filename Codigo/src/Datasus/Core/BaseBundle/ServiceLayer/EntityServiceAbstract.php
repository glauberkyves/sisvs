...
use \Datasus\Core\BaseBundle\ServiceLayer\Exception\NoRootEntityException;
use \Datasus\Core\BaseBundle\ServiceLayer\Exception\NoImplementationException;
use \Datasus\Core\BaseBundle\ServiceLayer\Exception\WrongTypeRootEntityException;
use \Datasus\Core\BaseBundle\ServiceLayer\Exception\ValidationException;
use \Datasus\Core\BaseBundle\EntityRepository\AbstractBase as EntityRepository;
use \Datasus\Core\BaseBundle\Entity\AbstractBase as Entity;
...
abstract class EntityServiceAbstract extends ServiceAbstract
{
    ...
    /**
     *
     * @var \Datasus\Core\BaseBundle\Entity\AbstractBase
     */
    protected $rootEntity = null;

    /**
     *
     * @var \Datasus\Core\BaseBundle\EntityRepository\AbstractBase
     */
     ...
     * 
     * @throws NoRootEntityException
     * @return \Datasus\Core\BaseBundle\EntityRepository\AbstractBase
     */
     ...
     * @param string $id            
     * @throws NoRootEntityException
     * @return \Datasus\Core\BaseBundle\Entity\AbstractBase
     */
    ...
    /**
     *
     * @param \Datasus\Core\BaseBundle\Entity\AbstractBase $entity            
