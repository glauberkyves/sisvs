 ...
 */
class SituacaoFormularioEntity extends \Datasus\Sisvs\ExpoEpi\FormularioBundle\Entity\SituacaoFormularioEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\FormularioBundle\\Entity\\SituacaoFormularioEntity' . "\0" . 'coSituacaoFormulario', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\FormularioBundle\\Entity\\SituacaoFormularioEntity' . "\0" . 'dsSituacaoFormulario', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\FormularioBundle\\Entity\\SituacaoFormularioEntity' . "\0" . 'coFormularioInscricao', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\FormularioBundle\\Entity\\SituacaoFormularioEntity' . "\0" . 'stAtivo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SituacaoFormularioEntity $proxy) {
    ...
    public function getCoSituacaoFormulario()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCoSituacaoFormulario();
        }
    ...
    public function setDsSituacaoFormulario($dsSituacaoFormulario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDsSituacaoFormulario', array($dsSituacaoFormulario));

        return parent::setDsSituacaoFormulario($dsSituacaoFormulario);
    }
    ...
    public function getDsSituacaoFormulario()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDsSituacaoFormulario', array());

        return parent::getDsSituacaoFormulario();
    }
    ...
    public function setCoFormularioInscricao($coFormularioInscricao)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCoFormularioInscricao', array($coFormularioInscricao));

        return parent::setCoFormularioInscricao($coFormularioInscricao);
    }
    ...
    public function getCoFormularioInscricao()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCoFormularioInscricao', array());

        return parent::getCoFormularioInscricao();
    }
