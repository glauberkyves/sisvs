 ...
 */
class InscricaoApresentacaoEntity extends \Datasus\Sisvs\ExpoEpi\AutorBundle\Entity\InscricaoApresentacaoEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\AutorBundle\\Entity\\InscricaoApresentacaoEntity' . "\0" . 'coInscricao', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\AutorBundle\\Entity\\InscricaoApresentacaoEntity' . "\0" . 'coApresentacao', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\AutorBundle\\Entity\\InscricaoApresentacaoEntity' . "\0" . 'dsApresentacao', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\AutorBundle\\Entity\\InscricaoApresentacaoEntity' . "\0" . 'nuOrdem', '' . "\0" . 'Datasus\\Sisvs\\ExpoEpi\\AutorBundle\\Entity\\InscricaoApresentacaoEntity' . "\0" . 'stAtivo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InscricaoApresentacaoEntity $proxy) {
